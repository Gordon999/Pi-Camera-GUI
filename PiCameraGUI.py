...
flicker     = 0       # reduce mains flicker, 0-3
drc         = 0       # dynamice range compression 0-3
...
still_limits = ['mode',0,len(modes)-1,'speed',0,len(speeds)-1,'ISO',0,800,'brightness',0,100,'contrast',-100,100,'ev',-12,12,'blue',0.1,8,'red',0.1,8,'extn',0,len(extns)-1,'effect',0,len(effects)-1,'meter',0,len(meters)-1,'awb',0,len(awbs)-1]
...
# draw sliders
draw_bar(0,2,lgrnColor,'speed',shutter)
            ...
            if button_row == 2:
                ...
                if mode == 0 :
                    if mousey < ((button_row-1)*bh) + 10:
                        speed = int(((mousex-preview_width) / bw) * (still_limits[((button_row-2)*3) + 2] - still_limits[((button_row-2)*3) + 1]))
                        shutter = speeds[speed]
                        if shutter < 0:
                            shutter = abs(1/shutter)
                        sspeed = int(shutter * 1000000)
                ...
                for f in range(0,len(still_limits)-1,3):
                    if still_limits[f] == 'ISO':
                        ...
                        pmax = still_limits[f+2]
                if mousey < ((button_row-1)*bh) + 10:
                    ISO = int(((mousex-preview_width) / bw) * (still_limits[((button_row-2)*3) + 2] - still_limits[((button_row-2)*3) + 1]))
                    if ISO < 100:
                        ISO = 0
                    elif ISO < 200:
                        ISO = 100
                ...
                for f in range(0,len(still_limits)-1,3):
                    if still_limits[f] == 'brightness':
                        ...
                        pmax = still_limits[f+2]
                if mousey < ((button_row-1)*bh) + 10:
                    brightness = int(((mousex-preview_width) / bw) * (still_limits[((button_row-2)*3) + 2] - still_limits[((button_row-2)*3) + 1])) 
                elif mousey < ((button_row-1)*bh) + (bh/1.2):
                    if mousex > preview_width + (bw/2):
                        brightness +=1
                ...
                for f in range(0,len(still_limits)-1,3):
                    if still_limits[f] == 'contrast':
                        ...
                        pmax = still_limits[f+2]
                if mousey < ((button_row-1)*bh) + 10:
                    contrast = int(((mousex-preview_width) / bw) * (still_limits[((button_row-2)*3) + 2] - still_limits[((button_row-2)*3) + 1])) - 100
                elif mousey < ((button_row-1)*bh) + (bh/1.2):
                    if mousex > preview_width + (bw/2):
                        contrast +=1
                ...
                for f in range(0,len(still_limits)-1,3):
                    if still_limits[f] == 'ev':
                        ...
                        pmax = still_limits[f+2]
                if mousey < ((button_row-1)*bh) + 10:
                    ev = int(((mousex-preview_width) / bw) * (still_limits[((button_row-2)*3) + 2] - still_limits[((button_row-2)*3) + 1])) - 12
                elif mousey < ((button_row-1)*bh) + (bh/1.2):
                    if mousex > preview_width + (bw/2):
                        ev +=1
                        ev = min(ev,pmax)
                ...
                for f in range(0,len(still_limits)-1,3):
                    if still_limits[f] == 'blue':
                        ...
                        pmax = still_limits[f+2]
                if mousey < ((button_row-1)*bh) + 10:
                    blue = (((mousex-preview_width) / bw) * (still_limits[((button_row-2)*3) + 2] - still_limits[((button_row-2)*3) + 1])) 
                elif mousey < ((button_row-1)*bh) + (bh/1.2):
                    if mousex < preview_width + (bw/2):
                        blue -=0.1
                        blue = max(blue,pmin)
                ...
                for f in range(0,len(still_limits)-1,3):
                    if still_limits[f] == 'red':
                        ...
                        pmax = still_limits[f+2]
                if mousey < ((button_row-1)*bh) + 10:
                    red = (((mousex-preview_width) / bw) * (still_limits[((button_row-2)*3) + 2] - still_limits[((button_row-2)*3) + 1])) 
                elif mousey < ((button_row-1)*bh) + (bh/1.2):
                    if mousex < preview_width + (bw/2):
                        red -=0.1
                        red = max(red,pmin)
