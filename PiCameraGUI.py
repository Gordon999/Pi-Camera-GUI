...
modes        = ['off','auto','night','sports','fireworks']
extns        = ['jpg','png','bmp','gif']
vwidths      = [640,800,1280,1280,1440,1920]
vheights     = [480,600, 720, 960,1080,1080]
v_max_fps    = [60 , 40,  40,  40,  40,  40]
speeds       = [-2000,-1600,-1250,-1000,-800,-640,-500,-400,-320,-250,-240,-200,-160,-144,-125,-120,-100,-96,-80,-60,-50,-48,-40,-30,-25,-24,-20,-15,-13,-10,-8,-6,-5,-4,-3,
...
while True:
    ...
    if os.path.exists('/run/shm/test.jpg'):
        ...
        if zoom == 1:
            ...
            v = (vheight/(vwidth/1.333)) * cheight
            pygame.draw.line(windowSurfaceObj,(155,150,0),(0,v),(cwidth,v))
        pygame.display.update()
    restart = 0
